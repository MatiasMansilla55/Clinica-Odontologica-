window.addEventListener('load', function () {
    ...
    formulario.addEventListener('submit', function (event) {
        ...
        const formData = {
            ...
            fechaYHora: document.querySelector("#fecha-y-hora").value,
    ...
    window.findBy = function findBy(id) {
          const url = 'http://localhost:8081/turnos/buscarId'+"/"+id;
          const settings = {
              method: 'GET'
          }
          fetch(url,settings)
          ...
          .then(data => {
              ...
              document.querySelector('#paciente').value = turno.paciente.apellido;
              document.querySelector('#odontologo').value = turno.odontologo.apellido;
              document.querySelector('#fecha-y-hora').value = turno.fechaYHora;
