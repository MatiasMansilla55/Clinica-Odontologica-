...
public class TurnoService implements ITurnoService {
    ...
    public TurnoSalidaDto registrarTurno(TurnoEntradaDto turno) throws BadRequestException {
        ...
        // Verificar si el paciente y el odontólogo en el turno son nulos
        /*if (turnoEntidad.getPaciente() == null && turnoEntidad.getOdontologo() == null) {
            LOGGER.error("No fue posible registrar el turno porque el paciente y el odontólogo son nulos");
            throw new BadRequestException("Paciente u odontólogo nulos en el turno");
        }*/
